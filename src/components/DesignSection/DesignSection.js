...
})
{
    return (
        <div className={`${css.class}`}>
            <p className="main-title-text">セクション</p>
            <div className="main-content">
                <p className="sub-title-1">見出し.1</p>
                <TextInput
                    required={true}
                    multiline={true}
                    rows="4"
                        ...
                        return (
                            <div key={p} className={p != 0 ? 'm-t-52' : ''}>
                                <div className="sub-content">
                                    <p className="sub-title-2">小見出し</p>
                                    <TextInput
                                        required={false}
                                        multiline={true}
                                        rows="4"
                                            ...
                                            return (<div key={b} className={b != 0 ? 'm-t-52' : ''}>
                                                ...
                                                <div className="sub-content-1-control">
                                                    <div className="control-left">
                                                        ...
                                                        <span className="btn-add" onClick={e => handleAddLevel2(index, 'section', p, 'article')}>画像と本文をを追加</span>
                                                    </div>
                                        ...
                                        v.files.map((a,b) => {
                                            return (<div key={b} className={b != 0 ? 'm-t-52' : ''}>
                                                ...
                                                <div className="file-sub-control">
                                                    ...
                                                    <span className="btn-add" onClick={e => handleAddLevel2(index, 'section', p, 'file')}>ファイルを追加</span>
                                                </div>
                                            </div>);
                                        })
                                    }
                                            ...
                                            return (<div key={b} className={b != 0 ? 'm-t-52' : ''}>
                                                ...
                                                <div className="sub-content-1-control">
                                                    <div className="control-left">
                                                        ...
                                                        <span className="btn-add" onClick={e => handleAddLevel2(index, 'section', p, 'product')}>画像と本文をを追加</span>
                                                    </div>
                                                    <div className="control-right">
                                ...
                                <div className="sub-content-1-control">
                                    <div className="control-left">
                                        ...
                                        <span className="btn-add" onClick={e => handleAddLevel1(index, 'section')}>画像と本文をを追加</span>
                                    </div>
                                    <div className="control-right">
